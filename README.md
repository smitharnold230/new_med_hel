...
- **Doctor Management**: Manage doctor details and upload prescriptions
- **Reminder System**: Automated email reminders for logs and appointments
- **AI Health Assistant**: Chat with AI and generate health insights (Groq API)
- **PDF Export**: Download health reports
